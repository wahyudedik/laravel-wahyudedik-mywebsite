...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg text-center">
            ...
            <h2 class="mt-4 text-2xl font-bold text-gray-900 dark:text-gray-100">Thank You!</h2>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Your feedback has been submitted successfully.</p>
