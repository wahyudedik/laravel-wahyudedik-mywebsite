            ...
            <form method="POST" action="{{ route('admin.resume.experience.update', [$resume, $experience]) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="current_job" 
                                    name="current_job" value="1" {{ old('current_job', $experience->current_job) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3" id="end_date_container">
                            ...
                            <input type="text" class="form-control @error('end_date') is-invalid @enderror" 
                                id="end_date" name="end_date" value="{{ old('end_date', $experience->end_date) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                id="description" name="description" rows="4" required>{{ old('description', $experience->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('responsibilities') is-invalid @enderror" 
                                id="responsibilities_text" rows="6">{{ old('responsibilities_text', is_array($experience->responsibilities) ? implode("\n", $experience->responsibilities) : '') }}</textarea>
                            <input type="hidden" id="responsibilities_json" name="responsibilities" 
                                value="{{ json_encode(old('responsibilities', $experience->responsibilities ?? [])) }}">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-device-floppy me-1"></i> Update Experience
                    </button>
                </div>
            </form>
        </div>
