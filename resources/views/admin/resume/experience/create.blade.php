                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="start_date" class="block mt-1 w-full" type="text"
                                        name="start_date" :value="old('start_date')" placeholder="e.g. Jan 2020" required />
                                ...
                                <div class="mb-4" id="end_date_container">
                                    ...
                                    <x-text-input id="end_date" class="block mt-1 w-full" type="text"
                                        name="end_date" :value="old('end_date')" placeholder="e.g. Dec 2022" />
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="responsibilities_text" rows="6"
                                        class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600">{{ old('responsibilities_text') }}</textarea>
