...
@section('header')
    <h2 class="fs-2 m-0">
        {{ __('Edit Resume') }}: {{ $resume->full_name }}
    </h2>
@endsection
...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.resume.update', $resume) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('full_name') is-invalid @enderror" 
                                id="full_name" name="full_name" value="{{ old('full_name', $resume->full_name) }}" required>
                            @error('full_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                id="email" name="email" value="{{ old('email', $resume->email) }}" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                                id="phone" name="phone" value="{{ old('phone', $resume->phone) }}" required>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                id="location" name="location" value="{{ old('location', $resume->location) }}" required>
                            @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control @error('website') is-invalid @enderror" 
                                id="website" name="website" value="{{ old('website', $resume->website) }}">
                            @error('website')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" 
                                    name="is_active" value="1" {{ $resume->is_active ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('about_me') is-invalid @enderror" 
                                id="about_me" name="about_me" rows="5" required>{{ old('about_me', $resume->about_me) }}</textarea>
                            @error('about_me')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('skills') is-invalid @enderror" 
                                id="skills_input" name="skills_input">
                            <div id="skills_container" class="d-flex flex-wrap gap-1 mt-2"></div>
                            <input type="hidden" id="skills_json" name="skills" 
                                value="{{ json_encode(old('skills', $resume->skills ?? [])) }}">
                            @error('skills')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="mt-2">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="url" class="form-control @error('social_links.github') is-invalid @enderror" 
                                        ...
                                        value="{{ old('social_links.github', $resume->social_links['github'] ?? '') }}" 
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="url" class="form-control @error('social_links.linkedin') is-invalid @enderror" 
                                        ...
                                        value="{{ old('social_links.linkedin', $resume->social_links['linkedin'] ?? '') }}" 
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="url" class="form-control @error('social_links.twitter') is-invalid @enderror" 
                                        ...
                                        value="{{ old('social_links.twitter', $resume->social_links['twitter'] ?? '') }}" 
                                    ...
                                    @foreach($resume->languages as $index => $language)
                                        <div class="language-item border rounded p-3 mb-2">
                                            <div class="d-flex justify-content-between mb-2">
                                                <h6 class="mb-0">Language {{ $index + 1 }}</h6>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input type="number" class="form-control form-control-sm" 
                                                    style="width: 70px;" name="languages[{{ $index }}][percentage]" 
                                                    min="1" max="100" value="{{ $language['percentage'] ?? 100 }}">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-device-floppy me-1"></i> Update Resume
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    let languageCount = {{ is_array($resume->languages) ? count($resume->languages) : 1 }};
