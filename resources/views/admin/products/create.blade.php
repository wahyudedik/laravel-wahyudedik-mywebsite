                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price_user') is-invalid @enderror" 
                                id="price_user" name="price_user" value="{{ old('price_user') }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price_developer') is-invalid @enderror" 
                                id="price_developer" name="price_developer" value="{{ old('price_developer') }}" 
                                step="0.01" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control @error('demo_link') is-invalid @enderror" 
                                id="demo_link" name="demo_link" value="{{ old('demo_link') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="featured" 
                                    value="1" id="featured" {{ old('featured') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Upload a product image (max 2MB). Recommended size: 800x600px.</div>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="product_file" class="form-label required">Product File</label>
                            <input type="file" class="form-control @error('product_file') is-invalid @enderror" 
                                id="product_file" name="product_file" required>
                            <div class="form-text">Upload the product file (ZIP, PDF, etc). Max size: 50MB.</div>
                            @error('product_file')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
